#!/usr/bin/env bash
# The fixture suite under the compiler in Onus (impl spec §10; docs/CHANGES.md
# items 198 and 199): `run_fixtures.js`, built from `self/fixtures.onus` by
# the bootstrap chain, over every fixture directory's `fixtures.json`. The
