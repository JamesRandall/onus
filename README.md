...
Milestones 1–3 done: lexer, parser, canonical printer, `onus fmt`; module
loading, name resolution, the type checker and the effects pass (`onus check` runs passes 1–6,
...
pnpm -r build
pnpm -r test
pnpm onus check <file.onus> [--json] [--root <dir>] [--stdlib <dir>] [--to parse|canonical|resolve|types|effects]
