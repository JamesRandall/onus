...
const report: PathReport = {
  ...
  assumes: [{ claim: 'v.C', at: 'v.leaf', justification: 'vendor <contract>', permitted_by: 'except', verifiable: true, verify: 'verify(c: Client) may io.net {\n  true\n}', last_verified: { at: '2026-09-04T00:00:00Z', target: 'staging', result: 'passed' } }],
