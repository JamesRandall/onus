...
const IMPLS: ReadonlyMap<string, Impl> = new Map<string, Impl>([
  ...
  ['std.text.count', (a) => runtime.text.count(str(a[0]))],
  ['std.text.code_points', (a) => runtime.text.code_points(str(a[0]))],
  ['std.text.of_code_points', (a) => runtime.text.of_code_points(arr(a[0]).map(num))],
  ['std.text.of_code_point', (a) => runtime.text.of_code_point(num(a[0]))],
  ['std.text.slice', (a) => runtime.text.slice(str(a[0]), num(a[1]), num(a[2]))],
  ['std.text.index_of', (a) => runtime.text.index_of(str(a[0]), str(a[1]), num(a[2]))],
  ['std.text.contains', (a) => runtime.text.contains(str(a[0]), str(a[1]))],
  ['std.text.ends_with', (a) => runtime.text.ends_with(str(a[0]), str(a[1]))],
  ['std.text.split', (a) => runtime.text.split(str(a[0]), str(a[1]))],
  ['std.text.join', (a) => runtime.text.join(arr(a[0]).map(str), str(a[1]))],
  ['std.text.repeat', (a) => runtime.text.repeat(str(a[0]), num(a[1]))],
  ['std.text.replace', (a) => runtime.text.replace(str(a[0]), str(a[1]), str(a[2]))],
  ['std.text.compare', (a) => runtime.text.compare(str(a[0]), str(a[1]))],
  ['std.text.upper', (a) => runtime.text.upper(str(a[0]))],
  ['std.int.parse', (a) => runtime.int.parse(str(a[0]))],
  ['std.float.parse', (a) => runtime.float.parse(str(a[0]))],
